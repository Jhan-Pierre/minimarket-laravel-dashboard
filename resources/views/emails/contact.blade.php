...
<body>
    <section class="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
        ...
        <main class="mt-8">
            <h2 class="text-gray-700 dark:text-gray-200">Hi Luis,</h2>
    
            <p class="mt-2 leading-loose text-gray-600 dark:text-gray-300">
                Alicia has invited you to join the team on <span class="font-semibold ">Grupo 03</span>.
            </p>
        ...
        <footer class="mt-8">
            ...
            <p class="mt-3 text-gray-500 dark:text-gray-400">© {{ date('Y') }} Grupo 03. All Rights Reserved.</p>
        </footer>
    </section>
</body>
</html>